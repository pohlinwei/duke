...
public class ChangeStorageCommand implements Command {
     ...
     * loaded onto <code>manager</code>.Informs user whether the change in storage file has been successful.
     *
     ...
     * @return string informing user whether the execution is successful
     */
